...
import { MyRecipes } from "../GraphQl/query";
import {
  Box,
  Grid,
  Typography,
...
const MyRecipesPage = () => {
  const { data, refetch: refetchMyRecipes } = useQuery(MyRecipes);
  ...
  const filteredRecipes = data?.myRecipes?.filter((recipe) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <FormControl sx={{ minWidth: 200 }} sx={{ minWidth: 200, width: "20%" }}>
